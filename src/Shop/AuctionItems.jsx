...
const terminator = {
  ...
  description:
    "A true to life sized representation of Terminator on VHS, double sided. Porcelain and one billion glazes, some rare earth colour changing glazes. Cone 6 Oxidation. ",
...
const oyster = {
  ...
  description:
    "A life sized BC Oyster (BC because it's pretty big). This piece was atmospherically fired in the gas reduction salt kiln at Medalta in Medicine Hat Alberta during a year-long artist residency from September 2024 to present. This oyster has no glaze and was made using nerikomi techniques with coloured clay. The firing process makes a glazed surface with singular results. Porcelain, stains and oxides. Reduction salt fired, cone 10. Sculptural nerikomi pieces, especially fired in the atmospheric kilns may have small cracks and imperfections that are to be embraced.",
...
const pomegranate = {
  ...
  description:
    "A life sized Pomegranate half. This piece was atmospherically fired in the gas reduction salt kiln at Medalta in Medicine Hat Alberta during a year-long artist residency from September 2024 to present. This piece has no glaze and was made using nerikomi techniques with coloured clay. The firing process makes a glazed surface with singular results. Porcelain, stains and oxides. Reduction salt fired, cone 10. Sculptural nerikomi pieces, especially fired in the atmospheric kilns may have small cracks and imperfections that are to be embraced. ",
  imgSrc: [pomegranate1, pomegranate2],
...
const boot = {
  ...
  itemName: "The Boot",
  description:
    "A size 8 nerikomi Doc Martin boot. This piece was atmospherically fired in the gas reduction salt kiln at Medalta in Medicine Hat Alberta during a year-long artist residency from September 2024 to present. This boot has no glaze and was made using repeating pattern nerikomi cane with coloured clay. The firing process makes a glazed surface with singular results. Porcelaneous stoneware, stains and oxides. Reduction salt fired, cone 10. Sculptural nerikomi pieces, especially fired in the atmospheric kilns may have small cracks and imperfections that are to be embraced. This piece specifically has a large crack (shown in photos) that is mostly on the bottom of the piece and has been priced accordingly.",
...
const grapes = {
  ...
  itemName: "Grapes",
  description:
    'A large bunch of grapes approx 8"x5"x5". This piece was atmospherically fired in the gas reduction salt kiln at Medalta in Medicine Hat Alberta during a year-long artist residency from September 2024 to present. These stripey grapes have no glaze and were made using nerikomi techniques with coloured clay. The firing process makes a glazed surface with singular results. Porcelain, stains and oxides. Reduction salt fired, cone 10. Sculptural nerikomi pieces, especially fired in the atmospheric kilns may have small cracks and imperfections that are to be embraced. ',
...
const matches = {
  ...
  description:
    "A life sized book of matches using nerikomi cane pattern and reactive colour with tiny matches inside. This piece was atmospherically fired in the gas reduction salt kiln at Medalta in Medicine Hat Alberta during a year-long artist residency from September 2024 to present. This matchbook has no glaze and was made using nerikomi techniques with coloured clay. The firing process makes a glazed surface with singular results. Porcelain, stains and oxides. Reduction salt fired, cone 10. Sculptural nerikomi pieces, especially fired in the atmospheric kilns may have small cracks and imperfections that are to be embraced. ",
